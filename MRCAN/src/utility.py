...
class checkpoint():
    def __init__(self, args):
        ...
        if not args.load:
            ...
            self.dir = os.path.join('/home/user1/JWL/RCAN-PyTorch-master/experiment', args.save)
        else:
            #self.dir = os.path.join('..', 'experiment', args.load)
            self.dir = os.path.join('/home/user1/JWL/RCAN-PyTorch-master/experiment', args.load)
